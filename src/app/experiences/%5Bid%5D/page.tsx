...
const experiencesData: Record<string, ExperienceData> = {
  'shikara-journey': {
    ...
    itinerary: [
      { time: '05:30 AM', title: 'Embarkation from Nagin Nest', desc: 'Board the cushioned shikara directly from our private wooden deck, wrapping up in warm blankets as the lake remains asleep.' },
      ...
      { time: '08:00 AM', title: 'Return & Breakfast', desc: 'Arrive back at Nagin Nest for a traditional breakfast on the dining deck.' }
    ]
  },
  'wazwan-experience': {
  ...
  'valley-trek': {
    ...
    itinerary: [
      ...
      { time: '05:30 PM', title: 'Sunset Return', desc: 'Arrive back at Nagin Nest in time for evening tea as the sun sets behind the Zabarwan range.' }
    ]
  }
};
...
export async function generateMetadata({ params }: { params: Promise<{ id: string }> }) {
  ...
  return {
    title: exp ? `${exp.title} | Nagin Nest Houseboats` : 'Experience Not Found | Nagin Nest',
